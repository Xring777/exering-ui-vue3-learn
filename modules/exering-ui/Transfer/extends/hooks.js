...
export function useCheckedData() {
  ...
  function addCheckedData(leftOrRright, item) {
    switch (leftOrRright) {
      case "left":
  ...
  function removeCheckedData(leftOrRright, id) {
    switch (leftOrRright) {
      case "left":
        checkedData.left.filter((item) => item.id !== id);
        break;
      case "right":
        checkedData.right.fliter((item) => item.id !== id);
        break;
      default:
        break;
    }
